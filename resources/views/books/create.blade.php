    ...
    <div class="col-md-8">
        <div class="card border-0 shadow-lg rounded-4">
            <div class="card-header bg-primary text-white py-4 rounded-top-4">
                <h4 class="mb-0 fw-bold"><i class="bi bi-plus-circle me-2"></i> Tambah Koleksi Buku</h4>
            </div>
            <div class="card-body p-4 p-lg-5 bg-white rounded-bottom-4">
                <form action="{{ route('staff.books.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control bg-light border-0 py-2" id="title" name="title" value="{{ old('title') }}" required placeholder="Masukkan judul buku lengkap">
                        @error('title')
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control bg-light border-0 py-2" id="isbn" name="isbn" value="{{ old('isbn') }}" placeholder="Contoh: 978-602-...">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="stock" class="form-label text-muted small fw-bold">Stok Tersedia</label>
                            <input type="number" class="form-control bg-light border-0 py-2" id="stock" name="stock" value="{{ old('stock', 0) }}" required min="0">
                        </div>
                    </div>

                    <div class="mb-4">
                        <label for="cover_image" class="form-label text-muted small fw-bold">Unggah Gambar Sampul</label>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <button type="submit" class="btn btn-primary px-5 py-3 rounded-3 fw-bold shadow">
                            SIMPAN BUKU <i class="bi bi-check-circle ms-2"></i>
                        </button>
                    </div>
                </form>
            </div>
